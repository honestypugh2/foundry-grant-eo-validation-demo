...
document_data = doc_agent.process_document(test_file)
    ...
    print(f'   → Passed to Step 2 (Summarization)')
    ...
    print(f'\n📦 Data Output: summary')
    print(f'   → Passed to Step 3 (Compliance Validation)')
    ...
    print('=' * 80)
    print('Agent: ComplianceValidatorAgent')
    print('Purpose: Analyze compliance with executive orders')
    print()
    print('📥 Input from Previous Steps:')
    print(f'   - document_data["text"]: From Step 1')
    print(f'   - summary: From Step 2')
    ...
    print(f'   → Passed to Step 4 (Risk Scoring)')
    ...
    print()
    print('📥 Input from Previous Steps:')
    print(f'   - compliance_report: From Step 3')
    ...
    print(f'   → Passed to Step 5 (Email Notification)')
    ...
    print('📥 Input from Previous Steps:')
    print(f'   - risk_report: From Step 4')
    print(f'   - compliance_report: From Step 3')
    print(f'   - summary: From Step 2')
    print(f'   - metadata: From Step 1')
    print()
    ...
    if requires_notification:
        print(f'⚠️  Risk threshold exceeded - notification required')
        ...
        print(f'ℹ️  Risk within acceptable range - no notification required')
        workflow_results['steps']['notification'] = {
            'status': 'skipped',
            'reason': 'Not required'
        }
    ...
    print(f'\n🔄 Data Flow Verified:')
    print(f'   Step 1 → Step 2: ✅ document_data, metadata')
    print(f'   Step 2 → Step 3: ✅ summary (executive_summary, key_clauses, key_topics)')
    print(f'   Step 3 → Step 4: ✅ compliance_report (with confidence_score)')
    print(f'   Step 4 → Step 5: ✅ risk_report')
    print(f'   All Steps → Final: ✅ Complete workflow_results')
    
    print(f'\n📱 Streamlit App Integration:')
    print(f'   This data structure matches what streamlit_app_new.py expects')
    print(f'   Results can be displayed in the dashboard with all tabs populated')
